...
* @Date:2017/12/17
*
* @Description:adapted from ulwanski https://github.com/ulwanski/md5
*/
#include "stdafx.h"
#include "md5.h"
...
void Hash_MD5::MD5_Init(MD5_CTX* ctx) {
    ctx->a = 0x67452301;
    ctx->b = 0xefcdab89;
    ctx->c = 0x98badcfe;
    ctx->d = 0x10325476;
...
STRX Hash_MD5::Generate(CSTRX dat) {
    string rec;
...
STRX Hash_MD5::GenerateFile(CSTRX filename) {
